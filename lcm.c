...
long long populationPrompt();
long long scanNumber(long long i);
long long leastCommonMultiple(long long *arr, long long population);
...
long long population = populationPrompt();
...
long long pairMultiple(long long x, long long y) {
		long long count = 1;
		while (count <= 9223372036854775807) {
